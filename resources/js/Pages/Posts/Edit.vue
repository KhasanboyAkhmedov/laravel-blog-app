...
const submit = () => form.patch(route('posts.update', props.post.id));
</script>
    ...
    <AdminLayout>
        <template #header>
            <nav class="flex items-center gap-2 text-xs text-on-surface-variant">
                ...
                <span class="material-symbols-outlined text-[14px]">chevron_right</span>
                <span class="text-primary font-semibold">Edit Post</span>
            </nav>
        </template>
        ...
        <div class="max-w-3xl mx-auto space-y-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-on-surface tracking-tight">Edit Post</h2>
                    <p class="text-xs text-on-surface-variant mt-0.5 line-clamp-1">{{ post.title }}</p>
                </div>
            </div>
            ...
            <div class="bg-white border border-outline-variant rounded-xl shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-outline-variant bg-surface-container-low">
                    <p class="text-xs text-on-surface-variant">Update the fields below and save your changes.</p>
                </div>
