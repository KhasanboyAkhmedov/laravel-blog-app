...
return new class extends Migration
{
    public function up(): void
    {
        DB::transaction(function () {
            ...
            // Remove any Spatie rows with non-User model types (would block ADD PRIMARY KEY)
            DB::statement('DELETE FROM model_has_roles WHERE model_id IS NULL');
            DB::statement('DELETE FROM model_has_permissions WHERE model_id IS NULL');
